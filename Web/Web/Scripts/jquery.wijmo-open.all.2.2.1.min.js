...
$.fn.bgiframe = ($.browser.msie && /msie 6\.0/i.test(navigator.userAgent) ? function(s) {
    ...
    var html = '<iframe class="bgiframe"frameborder="0"tabListing="-1"src="'+s.src+'"'+
                   'style="display:block;position:absolute;z-Listing:-1;'+
